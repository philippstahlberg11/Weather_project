...
public interface IWeatherModell {
     ...
     * @param detailString a string which represents for which value you want a unit for
     ...
     * @return a array with strings representing different values like temperature etc.
     */
    ArrayList<String> genericDetailsInfoList();


    /**
     * An arraylist with string of the most generic information titles one would want
     * @return a array with string representing different titles for values, like "Time" etc.
     */
     ...
     * @return an arraylist with all the different information in the next hours/hour (length is specified after timeLimit)
     */
     ...
     * @param timeNext shows the time "summary" either .0 - 1 - 2. (0-5hours, 6-11hours, 12+ hours)
     ...
     * @param time an int representing at which time it gets the corresponding value
     * @param detailString an string, which value one want's to get, example: air_temperature
     ...
     * @param arrayList an arraylist consisting of integers, that may have duplicates
     ...
     * @return a 2D-arraylist, that shows all the values of one day in the first place, etc.
     */
